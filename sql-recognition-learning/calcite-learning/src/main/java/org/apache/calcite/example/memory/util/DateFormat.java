package org.apache.calcite.example.memory.util;
...
public class DateFormat {
    ...
    static final private Map<String, ThreadLocal<SimpleDateFormat>> threadLocalMap = new ConcurrentHashMap<>();
    ...
    public static SimpleDateFormat getDateFormat(String datePattern) {
        ...
        if (formatThreadLocal == null) {
            threadLocalMap.put(datePattern, formatThreadLocal = new ThreadLocal<>());
        }
