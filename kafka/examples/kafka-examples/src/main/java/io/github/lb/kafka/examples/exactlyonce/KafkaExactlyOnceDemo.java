package io.github.lb.kafka.examples.exactlyonce;

import io.github.lb.kafka.examples.simple.Consumer;
import io.github.lb.kafka.examples.simple.KafkaProperties;
import io.github.lb.kafka.examples.simple.Producer;
...
public class KafkaExactlyOnceDemo {
  ...
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    Consumer consumerThread = new Consumer(
            OUTPUT_TOPIC, "Verify-consumer", Optional.empty(), true, numRecords, consumeLatch);
